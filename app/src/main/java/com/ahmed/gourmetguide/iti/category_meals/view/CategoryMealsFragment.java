...
import com.ahmed.gourmetguide.iti.category_meals.presenter.CategoryMealsPresenter;
import com.ahmed.gourmetguide.iti.model.remote.CategoryMealsDTO;
import com.ahmed.gourmetguide.iti.repo.Repository;

import java.util.List;

public class CategoryMealsFragment extends Fragment implements OnCategoryMealsView {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        clickedCategoryName = CategoryMealsFragmentArgs.fromBundle(getArguments()).getCategoryName();
