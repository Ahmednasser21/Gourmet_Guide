...
import com.ahmed.gourmetguide.iti.emailSignup.presenter.SignupWithEmailPresenter;
...
public class SignUpWithEmailFragment extends Fragment implements SignupWithEmailView {
    ...
    public void navigateToOnBoarding() {
        NavDirections action = SignUpWithEmailFragmentDirections.actionSignUpWithEmailToOnBoardFragment();
        Navigation.findNavController(getView()).navigate(action);
    }

    @Override
    public void navigateToLogin() {
        NavDirections action = SignUpWithEmailFragmentDirections.actionSignUpWithEmailToLoginFragment();
        Navigation.findNavController(getView()).navigate(action);
    }
